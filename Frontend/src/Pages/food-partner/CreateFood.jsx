...
const CreateFood = () => {
    ...
    const onSubmit = async (e) => {
        ...
        // Optionally show an error message to the user here using state or a toast notification    
    }finally{
        // Any cleanup if needed after submission attempt   
        ...
        <div className="create-food-page">
            <div className="create-food-card">
                ...
                <form className="create-food-form" onSubmit={onSubmit}>
                    ...
                    <div className='field-group'>
                        <label htmlFor="foodThumbnail">Thumbnail (optional)</label>
                        <input
                            id="foodThumbnail"
                            type="file"
                            accept="image/*"
                        ...
                        />
                        {thumbnailFile && (
                            <div className="thumbnail-preview-container" style={{marginTop: '12px'}}>
